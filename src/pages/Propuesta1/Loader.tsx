...
export default function Loader({ onLoaded }: LoaderProps) {
  ...
  return (
    ...
    >
      ...
      >
        <line x1="16" y1="3" x2="16" y2="29" stroke="#502129" strokeWidth="2.2" strokeLinecap="round" />
        <line x1="6" y1="11" x2="26" y2="11" stroke="#502129" strokeWidth="2.2" strokeLinecap="round" />
      </svg>
