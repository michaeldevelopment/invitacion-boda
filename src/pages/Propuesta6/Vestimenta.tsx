import { IconPercha } from "../Propuesta5/shared/icons";
...
function PinterestIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 24 24" fill={VINO} xmlns="http://www.w3.org/2000/svg">
  ...
  return (
    <section style={{ backgroundColor: "#E8E1D3", padding: "3rem 1.75rem", textAlign: "center" }}>
      <div style={{ maxWidth: 380, margin: "0 auto" }}>
        ...
        >
          Te sugerimos elegir tonos claros y suaves que armonicen con el ambiente íntimo y cálido que queremos crear juntos.
        </p>
