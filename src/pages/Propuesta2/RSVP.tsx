...
const TEXTO_RSVP =
  "Por favor confírmanos tu asistencia antes del 12 de junio. Después de esa fecha, si no hemos recibido respuesta, asumiremos con amor que no podrás acompañarnos.";
...
export default function RSVP() {
  ...
  return (
    <div
      ref={sectionRef}
      id="p5-rsvp"
      className="p5-section py-24 px-5 sm:px-8 relative flex items-center justify-center overflow-hidden"
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-lg mx-auto text-center">
        {/* Título */}
        <div className="p5-rsvp-title mb-10">
          <h2
        ...
        {/* Typewriter */}
        <div
          className="p5-rsvp-content mb-10 border-l-2 pl-5 text-left"
        ...
        >
          ...
          />
          <span className="p5-cursor" aria-hidden="true" />
        </div>

        {/* Botón WhatsApp */}
        <div className="p5-rsvp-content pt-4">
          <a
            href={WHATSAPP_URL}
            target="_blank"
            rel="noopener noreferrer"
            className="block sm:inline-block w-full sm:w-auto border-2 font-serif tracking-[0.35em] uppercase transition-all duration-300"
            style={{
              borderColor: "#E8E1D3",
              color: "#E8E1D3",
        ...
        {/* Cierre */}
        <div className="p5-rsvp-content pt-12">
          <p
