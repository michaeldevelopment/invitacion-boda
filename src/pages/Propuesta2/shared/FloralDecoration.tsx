...
export default function FloralDecoration({
  ...
  return (
    ...
    >
      ...
      >
        <path
          d="M50 128 Q46 95 35 62 Q22 28 12 8"
          stroke="#7A8D61"
          strokeWidth="1.2"
          strokeLinecap="round"
          fill="none"
        ...
        />
        <path
          d="M35 62 Q5 48 2 22 Q22 20 35 62Z"
          fill="#7A8D61"
          opacity="0.45"
        />
        <path
          d="M38 72 Q68 60 65 38 Q48 42 38 72Z"
          fill="#7A8D61"
          opacity="0.4"
        />
        <path
          d="M22 28 Q2 14 5 0 Q22 8 22 28Z"
          fill="#7A8D61"
          opacity="0.35"
        />
