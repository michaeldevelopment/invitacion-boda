...
import { IconPercha } from "./shared/icons";
...
export default function DressCode() {
  ...
  useGSAP(
    () => {
      ...
      gsap.from(".p5-dc-swatches", {
        ...
        delay: 0.1,
        scrollTrigger: {
          trigger: ".p5-dc-swatches",
          start: "top 88%",
          toggleActions: "play none none none",
        },
      });

      gsap.from(".p5-dc-pinterest", {
        opacity: 0,
        y: 16,
        duration: 0.7,
        ease: "power2.out",
  ...
  return (
    <div
      ref={sectionRef}
      id="p5-dresscode"
      className="py-16 sm:py-20 md:py-24 px-5 sm:px-8"
      style={{ backgroundColor: "#f0ebe2", minHeight: "unset" }}
    >
      <div className="max-w-lg mx-auto text-center">
        {/* Header con icono */}
        <div className="p5-dc-header mb-10">
          <div className="flex justify-center mb-5">
            <IconPercha color="#60141A" size={32} />
          </div>
          <h2
        ...
        <div className="p5-dc-text mb-8">
          ...
          />
          <p
            className="font-serif text-base font-bold tracking-wide mb-8"
            style={{ color: "#60141A" }}
          >
            NO USAR ESTAMPADOS
          </p>
        ...
        {/* Enlace Pinterest */}
        <div
          className="p5-dc-pinterest pt-8"
          style={{ borderTop: "1px solid rgba(96,20,26,0.12)" }}
        >
          <p
            className="font-serif text-sm tracking-[0.2em] uppercase mb-6"
            style={{ color: "rgba(96,20,26,0.9)" }}
          >
          ...
          >
            ...
            <span
              className="font-serif italic text-base pb-px"
              style={{
                borderBottom: "1px solid rgba(96,20,26,0.4)",
                color: "#60141A",
              }}
            >
            ...
            <span
              className="font-serif text-sm transition-transform duration-300 group-hover:translate-x-1"
