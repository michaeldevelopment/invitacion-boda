...
const LINKS = [
  { label: "Inicio", id: "p5-hero" },
  { label: "Ceremonia", id: "p5-ubicacion" },
  { label: "Hospedaje", id: "p5-hospedaje" },
  { label: "Dress Code", id: "p5-dresscode" },
  { label: "Asistencia", id: "p5-rsvp" },
];
      ...
      >
        {LINKS.map((link) => (
          <button
            ...
            onMouseLeave={(e) =>
              (e.currentTarget.style.color = "rgba(96,20,26,0.65)")
            }
          >
            {link.label}
          </button>
