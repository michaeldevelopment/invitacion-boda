...
const HOTELES: Hotel[] = [
  {
    ...
    referencia: 'El Poblado, Cl. 7 #43-60',
    url: 'https://www.booking.com/hotel/co/dann-carlton-medellin.html',
    cerca: 'iglesia',
    bg: '#ddd5c5',
  },
  {
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="p4-hosp-header text-center mb-14">
          ...
          <p className="font-serif text-sm italic" style={{ color: 'rgba(96,20,26,0.6)' }}>
            Opciones cercanas a la iglesia y al lugar de recepción
          </p>
        </div>

        {/* Cards */}
        <div className="p4-hosp-grid grid grid-cols-1 md:grid-cols-3 gap-5">
          {HOTELES.map((h) => (
            <a
              key={h.nombre}
              href={h.url}
            ...
            >
              ...
              <div
                className="p4-hospedaje-img-wrap h-36 relative overflow-hidden"
