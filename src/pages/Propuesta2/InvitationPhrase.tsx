...
export default function InvitationPhrase() {
  ...
  useGSAP(
    () => {
      ...
      // Heartbeat en los separadores del countdown
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-3xl mx-auto text-center">
        {/* Bloque 1 — Frase de invitación */}
        <p
          className="font-serif italic leading-relaxed"
          style={{ fontSize: "clamp(1.5rem, 3.5vw, 2.6rem)", color: "#3a0d10" }}
        >
          {words.map((word, i) => (
            <span key={i}>
              <span
