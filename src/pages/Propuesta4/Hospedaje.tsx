        ...
        <div className="p4-hosp-grid grid grid-cols-1 md:grid-cols-2 gap-5">
          {HOTELES.map((h) => (
            ...
            >
              ...
              <div className="p-6">
                <p
                  className="font-serif text-[0.6rem] tracking-[0.2em] uppercase mb-1"
                  style={{ color: "#AB7E6C" }}
                >
                  {h.tipo}
                </p>
                <h3
                  className="font-serif font-light text-base mb-2 leading-snug"
                  style={{ color: "#60141A" }}
                >
                  {h.nombre}
                </h3>
                ...
                <p
                  className="font-serif text-[0.6rem] tracking-widest uppercase mt-4"
                  style={{ color: "#AB7E6C" }}
                >
                  Ver opciones →
                </p>
